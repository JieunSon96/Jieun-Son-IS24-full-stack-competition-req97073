...
<br><br>   
  <form class="form-inline">
    <input class="form-control " style="width:80% !important;" type="search" @keyup.enter="searchKeyword" placeholder="Search" aria-label="Search" v-model="searchKeyword"> 
...
export default {
    ...
    methods: {
        ...
        /* Search ScrumMasterName or Developers Method */
        searchKeywordMethod(){
